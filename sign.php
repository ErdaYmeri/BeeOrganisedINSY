	...
	<body id="top">
		...
		<?php
				...
				if(isset($_GET['register'])) {
				 ...
				 $statement = $pdo->prepare("INSERT INTO beeuser (vname, fname, email, usrname, passwort, gebtag, aktiv, level) VALUES (:vname, :fname, :email, :usrname, :passwort, :gebtag, 0, 'user')");
